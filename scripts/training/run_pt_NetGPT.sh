...
pretrained_model=/data/Chinese-LLaMA-2/chinese-llama-2-7b-hf
chinese_tokenizer_path=/data/Chinese-LLaMA-2/chinese-llama-2-7b-hf
dataset_dir=/data/Chinese-LLaMA-2/data
data_cache=/data/Chinese-LLaMA-2/cache
per_device_train_batch_size=1
gradient_accumulation_steps=8
block_size=512
output_dir=/data/Chinese-LLaMA-2/output
